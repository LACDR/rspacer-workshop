...
-   have a rendered LACDR-ISA HTML file from a LACDR-ISA Quarto template. You can use the example from Tutorial 2 or try your own.
...
This tutorial is a specific adaptation from the rspacer [article](https://burgerga.github.io/rspacer/articles). That tutorial is written more general. Here, we will show how to upload LACDR-ISA documents. This can be done with an additional template that is installed when installing LACDR-ISA.
...
Next, we will perform a similar workflow for Excel files.
